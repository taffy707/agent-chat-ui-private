...
>(({ className, children, checked, checkPosition = "left", ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center rounded-sm py-1.5 text-sm transition-colors outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      checkPosition === "left" ? "pr-2 pl-8" : "pr-8 pl-2",
      className,
    )}
    checked={checked}
    {...props}
